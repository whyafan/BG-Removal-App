    ...
    <header className="py-3">
      ...
      <div className="flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6 text-slate-500">
          ...
          <button className="flex items-center gap-4 px-4 py-2 bg-[#313131] text-white rounded-full sm:px-8 text-[12px] lg:text-sm">
            {/* Text: CTA label. */}
            Get Started
      ...
      <div
        ...
        className={`${isOpen ? "block" : "hidden"} md:hidden mt-3 rounded-xl border border-slate-200 bg-white p-3`}
      >
        ...
        <nav className="flex flex-col gap-3 text-slate-500">
          ...
          <button
            ...
            className="mt-1 flex w-full items-center justify-center gap-3 px-4 py-2 bg-[#313131] text-white rounded-full text-[12px]"
          >
